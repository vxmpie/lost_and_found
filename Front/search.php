...
<body >
    ...
    <form class="d-flex " role="search" style="width: 100%; padding-top: 100px;" method="get">
        <div class="input-group " style="width: 100%; display: flex; align-items: center; ">
            <input class="form-control rounded-pill search" type="search" placeholder="Search" aria-label="Search" name="q" id="searchInput" >
